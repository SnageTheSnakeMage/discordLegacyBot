/**
 * Unit tests for the freeze command.
 */
...
const freeze = require('../../../commands/Class Commands/freeze');
...
describe('freeze command', () => {
  beforeEach(() => {
    ...
    const playerClass = createFakeClass({ Class_Name: 'Snowman' });
  ...
  it('exports data and execute', () => {
    expect(freeze.data).toBeDefined();
    expect(freeze.execute).toBeDefined();
  ...
  it('defers reply', async () => {
    ...
    await freeze.execute(interaction);
