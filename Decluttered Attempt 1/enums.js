...
const ChaosEvents = Object.freeze({
  ...
  // "Double Trouble: EVERYTHING ACCELERATION": "AP distribution happens thrice and gives three tiles of free movement where it should only happen once while this chaos event is in play.",
  // "Double Trouble: Northern Hurricane": "Move everyone two(effectively six) spaces up every AP distribution while this chaos event is in play (Cannot move players onto ice,void, or wall tiles unless the player is a Cloudborn)",
  // "Double Trouble: Southern Hurricane": "Move everyone two(effectively six) spaces down every AP distribution & do everything in an AP distribution three times instead of once while this chaos event is in play (Cannot move players onto ice,void, or wall tiles unless the player is a Cloudborn)",
  // "Double Trouble: Eastern Hurricane": "Move everyone two(effectively six)  spaces right every AP distribution & do everything in an AP distribution three times instead of once while this chaos event is in play (Cannot move players onto ice,void, or wall tiles unless the player is a Cloudborn)",
  // "Double Trouble: Western Hurricane": "Move everyone two(effectively six) spaces left every AP distribution & do everything in an AP distribution three times instead of once while this chaos event is in play (Cannot move players onto ice,void, or wall tiles unless the player is a Cloudborn)",
