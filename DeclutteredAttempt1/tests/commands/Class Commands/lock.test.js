/**
 * Unit tests for the lock command.
 */
...
const lock = require('../../../commands/Class Commands/lock');
...
describe('lock command', () => {
  beforeEach(() => {
    ...
    const playerClass = createFakeClass({ Class_Name: 'Locksmith' });
    const tile = createFakeTile({ Layer_ID: 1, Tile_Type: 'Gateway_Open' });
  ...
  it('exports data and execute', () => {
    expect(lock.data).toBeDefined();
    expect(lock.execute).toBeDefined();
