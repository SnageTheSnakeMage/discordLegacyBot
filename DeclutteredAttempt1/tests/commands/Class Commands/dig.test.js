/**
 * Unit tests for the dig command.
 */
...
const dig = require('../../../commands/Class Commands/dig');
...
describe('dig command', () => {
  ...
  it('exports data and execute', () => {
    expect(dig.data).toBeDefined();
    expect(dig.execute).toBeDefined();
