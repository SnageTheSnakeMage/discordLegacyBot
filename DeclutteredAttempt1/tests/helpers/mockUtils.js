...
function createFakeEmptyPlaystate() {
  return {
    ...
    tiles: [
      createFakeTile({}),
      createFakeTile({Tile_ID: 2, X_Position: 2}),
      createFakeTile({Tile_ID: 3, X_Position: 2, Y_Position: 2, Tile_Type: 'Gateway_Open'}),
      createFakeTile({Tile_ID: 4, Y_Position: 2}),
      createFakeTile({Tile_ID: 5, Layer_ID: 2}),
      createFakeTile({Tile_ID: 6, Layer_ID: 2, X_Position: 2}),
      createFakeTile({Tile_ID: 7, Layer_ID: 2, X_Position: 2, Y_Position: 2, Tile_Type: 'Gateway_Open'}),
      createFakeTile({Tile_ID: 8, Layer_ID: 2, Y_Position: 2}),
    ],
  };
}
