...
module.exports = {
    ...
    async execute(interaction) {
        ...
        for (attackTile in attackPath) {
            ...
            //Check if the tile has no players on it
            if((tile.Tile_Type != "Wall" || tile.Tile_Type != "Wall_Damaged") && (tile.Player1 == null && tile.Player2 == null && tile.Player3 == null && tile.Player4 == null)){
                response += `Your shot zipped by ${attackPath[attackTile][0]},${attackPath[attackTile][1]}\n!`
            }
